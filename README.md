...
## Instalasi
1. Clone Repository
   `git clone [https://github.com/riskiyaya/aplikasi-manajemen-karyawan-backend-ta.git](https://github.com/risqitarawiyah/aplikasi-manajemen-karyawan-backend-ta.git)`
